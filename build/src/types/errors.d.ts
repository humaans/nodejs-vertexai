 ...
 */
declare class ClientErrorApi extends ClientError {
    readonly apiError: ErrorModal;
    constructor(message: string, apiError: ErrorModal);
}
/**
...
export { ClientError, ClientErrorApi, ErrorModal, GoogleAuthError, GoogleGenerativeAIError, IllegalArgumentError, };
